...
root.title("Kato Calculator") #Title for the application's main window

#Label - Entry Label where the expressions being clicked will be shown
answerEntryLabel = StringVar()
Label(root,font=('Times', 25, 'bold'), textvariable = answerEntryLabel, justify = LEFT,height=2, width=7).grid(columnspan=4, ipadx=120)
